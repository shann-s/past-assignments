...
namespace AssocAddEdit.Controllers
{
    public class Manager
    {
        ...
        {
            return Mapper.Map<IEnumerable<Country>, IEnumerable<CountryBase>>(ds.Countries.OrderBy(c => c.Name));
        }
        ...
        {
            return Mapper.Map<IEnumerable<Manufacturer>, IEnumerable<ManufacturerBase >> (ds.Manufacturers.OrderBy(m => m.Name));
        }
        ...
        public IEnumerable<ManufacturerWithDetail> ManufacturerGetAllWithDetail()
        {
            ...
            return Mapper.Map<IEnumerable<Manufacturer>, IEnumerable<ManufacturerWithDetail>>(c.OrderBy(m => m.Name));
        }
        ...
        public ManufacturerBase ManufacturerGetById(int id)
        {
            ...
            return (o == null) ? null : Mapper.Map<Manufacturer, ManufacturerBase>(o);
        }
        ...
        public ManufacturerWithDetail ManufacturerGetByIdWithDetail(int id)
        {
            ...
            return Mapper.Map<Manufacturer, ManufacturerWithDetail>(o);
        }
        ...
        {
            return Mapper.Map<IEnumerable<Vehicle>, IEnumerable<VehicleBase>>(ds.Vehicles.OrderBy(v => v.Model).ThenBy(v => v.Trim));
        }
        ...
        public IEnumerable<VehicleWithDetail> VehicleGetAllWithDetail()
        {
            ...
            return Mapper.Map<IEnumerable<Vehicle>, IEnumerable<VehicleWithDetail>>(c.OrderBy(v => v.Model).ThenBy(v => v.Trim));
        }
        ...
        public VehicleBase VehicleGetById(int id)
        {
            ...
            // Return the result, or null if not found
            return (o == null) ? null : Mapper.Map<Vehicle, VehicleBase>(o);
        }
        ...
        public VehicleWithDetail VehicleGetByIdWithDetail(int id)
        {
            ...
            return Mapper.Map<Vehicle, VehicleWithDetail>(o);
        }
        ...
        public VehicleWithDetail VehicleAdd(VehicleAdd newItem)
        {
            ...
            else
            {
                ...
                return (addedItem == null) ? null : Mapper.Map<Vehicle, VehicleWithDetail>(addedItem);
            }
        }
