...
namespace AssocManyToMany.Controllers
{
    public class Manager
    {
        ...
        {
            return Mapper.Map<IEnumerable<Employee>, IEnumerable<EmployeeBase>>(ds.Employees.OrderBy(e => e.Name));
        }

        public IEnumerable<EmployeeWithJobDuties> EmployeeGetAllWithJobDuties()
        {
            return Mapper.Map<IEnumerable<Employee>, IEnumerable<EmployeeWithJobDuties>>
        ...
        public EmployeeWithJobDuties EmployeeGetByIdWithDetail(int id)
        {
            ...
            return (o == null) ? null : Mapper.Map<Employee, EmployeeWithJobDuties>(o);
        }
        ...
        public EmployeeWithJobDuties EmployeeEditJobDuties(EmployeeEditJobDuties newItem)
        {
            ...
            else
            {
                ...
                return Mapper.Map<Employee, EmployeeWithJobDuties>(o);
            }
        }
        ...
        {
            return Mapper.Map<IEnumerable<JobDuty>, IEnumerable<JobDutyBase>>(ds.JobDuties.OrderBy(j => j.Name));
        }

        public IEnumerable<JobDutyWithEmployees> JobDutyGetAllWithEmployees()
        {
            return Mapper.Map<IEnumerable<JobDuty>, IEnumerable<JobDutyWithEmployees>>
        ...
        public JobDutyWithEmployees JobDutyGetByIdWithDetail(int id)
        {
            ...
            // Return the result, or null if not found
            return (o == null) ? null : Mapper.Map<JobDuty, JobDutyWithEmployees>(o);
        }
        ...
        public JobDutyWithEmployees JobDutyEditEmployees(JobDutyEditEmployees newItem)
        {
            ...
            else
            {
                ...
                return Mapper.Map<JobDuty, JobDutyWithEmployees>(o);
            }
        }
    }
}