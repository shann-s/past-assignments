...
namespace AssocSelf.Controllers
{
    public class Manager
    {
        ...
        {
            return Mapper.Map<IEnumerable<Employee>, IEnumerable<EmployeeBase>>
        ...
        public IEnumerable<EmployeeWithOrgInfo> EmployeeGetAllWithOrgInfo()
        {
            ...
            // Return the result
            return Mapper.Map<IEnumerable<Employee>, IEnumerable<EmployeeWithOrgInfo>>
        ...
        public EmployeeWithOrgInfo EmployeeGetByIdWIthOrgInfo(int id)
        {
            ...
            return (o == null) ? null : Mapper.Map<Employee, EmployeeWithOrgInfo>(o);
        }
        ...
        public EmployeeWithOrgInfo EmployeeEditSupervisor(EmployeeEditSupervisor newItem)
        {
            ...
            else
            {
                ...
                return Mapper.Map<Employee, EmployeeWithOrgInfo>(o);
            }
        }
