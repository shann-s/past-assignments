...
namespace Assignment_8.Controllers
{
    public class Manager
    {
        ...
        public bool LoadData()
        {
            ...
            //April 29, 1899
            DateTime dt = new DateTime(1899, 4, 29, 0, 0, 0, 0);
            String.Format("{0:MM/dd/yyyy}", dt);

            ds.Artists.Add(new Artist { Name = "Duke Ellington", BirthName = "Edward Kennedy Ellington", BirthOrStartDate =  dt, Id = 1});

            dt = new DateTime(1984, 10, 25, 0, 0, 0, 0);

            ds.Artists.Add(new Artist { Name = "Katy Perry", BirthName = "Katheryn Elizabeth Hudson", BirthOrStartDate = dt, Id = 2 });

            dt = new DateTime(1986, 10, 24, 0, 0, 0, 0);

            ds.Artists.Add(new Artist { Name = "Drake", BirthName = "Aubrey Drake Graham", BirthOrStartDate = dt, Id = 3 });
