    ...
    public class Manager
    {
        ...
        public Manager()
        {
            ...
            config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<Invoice, InvoiceWithRelatedObjects>();
                cfg.CreateMap<Employee, EmployeeWithRelatedObjects>();
        ...
        {
            return mapper.Map<IEnumerable<EmployeeBase>>(ds.Employees.OrderBy(c => c.EmployeeId));
        }
        public IEnumerable<InvoiceBase> InvoiceGetAll()
        { 
            return mapper.Map<IEnumerable<InvoiceBase>>(ds.Invoices.OrderBy(c => c.InvoiceId));
        }

        public InvoiceWithRelatedObjects InvoiceGetOne(int id)
        {
            var o = ds.Invoices
                .Include("Customer")
                .Include("InvoiceLines")
                .SingleOrDefault(p => p.InvoiceId == id);

            return (o == null) ? null : mapper.Map<Invoice, InvoiceWithRelatedObjects>(o);
        }

        public EmployeeWithRelatedObjects EmployeeGetOne(int id)
        {
            var o = ds.Employees
                .Include("Employee1")
                .Include("Employee2")
            ...
            return (o == null) ? null : mapper.Map<EmployeeWithRelatedObjects>(o);
        }

        public EmployeeBase EmployeeAdd(EmployeeAdd newItem)
        {
            var added = ds.Employees.Add(mapper.Map<EmployeeAdd, Employee>(newItem));

            ds.SaveChanges();

            return (added == null) ? null : mapper.Map<Employee, EmployeeBase>(added);
        }
